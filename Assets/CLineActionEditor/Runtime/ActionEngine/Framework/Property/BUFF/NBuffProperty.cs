...
namespace SuperCLine.ActionEngine
{
    ...
    {
        [SerializeField] private EAttributeType mAttr = EAttributeType.EAT_Max;
        ...
        [SerializeField] private string mKeepEffect = string.Empty;
        ...
        [EditorProperty("增减值(精度0.001)", EditorPropertyType.EEPT_Int, LabelWidth = 160)]
        public int AddValue
        {
            get { return mAddValue; }
            set { mAddValue = value; }
        }
        [EditorProperty("增减比率N%(N的精度0.001)", EditorPropertyType.EEPT_Int, LabelWidth = 160)]
        public int MulValue
        {
